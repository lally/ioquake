...
void SVC_Info( netadr_t from ) {
	...
	/*
	 * Check whether Cmd_Argv(1) has a sane length. This was not done
	 * in the original Quake3 version which led to the Infostring bug
	 * discovered by Luigi Auriemma. See http://aluigi.altervista.org/
	 * for the advisory.
	 */
